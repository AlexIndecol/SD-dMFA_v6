...
def run_loose_coupled(
    ...
    *,
    ...
    indicators_ts = {
        ...
        "Primary_refined_net_trade_endogenous": last_mfa.primary_refined_net_trade_endogenous,
        "Trade_refined_net_imports": last_mfa.trade_refined_net_imports,
        "Trade_concentrate_net_imports": last_mfa.trade_concentrate_net_imports,
        "Trade_scrap_net_imports": last_mfa.trade_scrap_net_imports,
        "Primary_available_to_refining": last_mfa.primary_available_to_refining,
        "Secondary_supply": last_mfa.secondary_supply,
        "Refined_input_required_pre_cap": last_mfa.refined_input_required_pre_cap,
        "Secondary_feed_gap_proxy": last_mfa.secondary_feed_gap_proxy,
        "Secondary_feed_surplus_proxy": last_mfa.secondary_feed_surplus_proxy,
        "Upstream_concentrate_gap_refined_equiv_proxy": last_mfa.upstream_concentrate_gap_refined_equiv_proxy,
        "Upstream_concentrate_surplus_refined_equiv_proxy": last_mfa.upstream_concentrate_surplus_refined_equiv_proxy,
